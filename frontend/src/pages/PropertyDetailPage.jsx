      ...
      <section className="max-w-6xl mx-auto px-4 md:px-6 py-6 md:py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Property title (mobile only — above gallery) */}
            <div className="lg:hidden bg-white rounded-3xl p-5 border border-slate-100 shadow-sm">
              <PropertyHeader item={item} variant="top" />
            </div>
...
function PropertyHeader({ item, variant = "full" }) {
  ...
  return (
    <div>
      ...
      {showBottom && (
        <>
          <div className={`${showTop ? "mt-4 pt-4 border-t border-slate-100" : ""}`}>
