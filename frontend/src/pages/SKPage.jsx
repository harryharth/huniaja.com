      ...
      <section className="bg-white py-14 md:py-20">
        <div className="max-w-6xl mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <aside className="md:col-span-1">
            <div className="md:sticky md:top-32 bg-slate-50 rounded-2xl p-4">
                ...
                {sections.map((s) => (
                  <li key={s.id}>
                    <a
                      ...
                      className={`flex items-center gap-2 text-sm rounded-lg px-2 py-2 transition ${
                        active === s.id
                          ? "bg-[#0025F5] text-white font-semibold"
